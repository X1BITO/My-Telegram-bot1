...
BOT_USERNAME = "Tiranga_new_prediction_bot"  # your actual bot username

async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    keyboard = [
        [InlineKeyboardButton("📊 About", callback_data="about")],
        [InlineKeyboardButton("💸 Earn", url=GAME_LINK)],
        [InlineKeyboardButton("📤 Share with Friends", url=f"https://t.me/share/url?url=https://t.me/{BOT_USERNAME}&text=💥 Join this Tiranga Game Bot & Start Earning Daily 💸")]
    ]
